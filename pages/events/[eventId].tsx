...
function SelectedEvent() {
  ...
  return (
    <div className="w-screen h-screen overflow-y-auto bg-primaryClr dark:btnClrDark">
      <div className="w-screen 2xl:h-[25rem] xl:h-52 lg:h-56 md:h-52 h-40 flex justify-center max-lg:items-center items-baseline bg-btnClrDark dark:bg-primaryClrDark">
      ...
      <div className="2xl:w-2/3 lg:w-1/2 w-2/3 2xl:h-[28rem] xl:h-72 lg:h-64 md:h-96 sm:h-[21rem] h-72 rounded-lg max-lg:my-8 md:my-16 max-lg:mx-auto flex lg:flex-row flex-col items-center lg:absolute 2xl:top-48 xl:top-20 lg:top-20 lg:left-[50%] lg:translate-x-[-50%] bg-white shadow-lg dark:bg-secondaryClrDark">
